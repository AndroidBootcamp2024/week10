...
import com.kodeco.android.countryinfo.ui.components.SplashScreen
...
fun CountryInfoNavHost(
    ...
    NavHost(navController = navController, startDestination = Screen.Spash.path) {
        composable(Screen.Spash.path) {
            SplashScreen {
